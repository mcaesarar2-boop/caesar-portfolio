...
export const Step1Profile: React.FC = () => {
  ...
  return (
    <div className="space-y-8 animate-fade-in">
      ...
      {/* Grid: Parameter Dasar (Jadwal, Durasi & Peserta) */}
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {/* 1. Jadwal & Durasi Perjalanan */}
        ...
        {/* 2. Jumlah Peserta & Aturan Pembobotan Anak */}
        <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm space-y-4">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-slate-100 pb-3">
            <div>
              ...
              <p className="text-xs text-slate-500 mt-0.5">
                Menentukan bobot konsumsi, porsi makan, dan tiket atraksi
              </p>
            </div>

            <div className="inline-flex items-center space-x-1 px-2.5 py-1 bg-amber-50 text-amber-800 rounded-full border border-amber-200 text-xs font-medium">
              <HeartHandshake className="w-3.5 h-3.5 text-amber-600" />
              <span>Anak = 50% porsi makan</span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-1">
            ...
            <div className="flex items-center justify-between p-3.5 rounded-xl border border-slate-200 bg-slate-50/50">
              <div>
                ...
                <p className="text-xs text-slate-500">Usia 12+ tahun</p>
              </div>
              <div className="flex items-center space-x-2">
                <button
                  type="button"
            ...
            <div className="flex items-center justify-between p-3.5 rounded-xl border border-slate-200 bg-slate-50/50">
              <div>
                ...
                <p className="text-xs text-slate-500">Usia 2–11 tahun</p>
              </div>
              <div className="flex items-center space-x-2">
                <button
                  type="button"
          ...
          <div className="text-xs text-slate-600 bg-slate-100/70 p-3 rounded-xl flex flex-col sm:flex-row sm:items-center justify-between gap-1">
            <span>
            ...
            <span className="text-blue-700 font-medium text-[11px]">
              Porsi Konsumsi Efektif: <strong>{profile.adults + profile.children * 0.5} porsi dewasa</strong>
            </span>
          </div>
        </div>
      </div>

      {/* KARTU KHUSUS: INPUT TIKET & MODA PERJALANAN (DENGAN RUTE, DESTINASI, KELAS, MOBIL, DAN ADD-ON) */}
