...
export const DEFAULT_INITIAL_STATE: TripState = {
  ...
  mainTransport: {
    ...
    isSplitTicket: false,
    ticketPricePerPerson: 1850000, // PP per person
  ...
  accommodation: {
    ...
    totalNights: 3,
    roomCount: 1,
    taxPercentage: 11, // PB1 / PPN
    depositAmount: 500000, // Refundable
  },
  fixedItems: [
    {
      id: 'fix-1',
  ...
  dailyCosts: {
    ...
    localTransport: {
      vehicleRentalDaily: 350000, // Sewa mobil harian
      fuelOrTransitDaily: 150000, // Bensin & parkir
    },
    activities: {
